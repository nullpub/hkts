...
//       ),
//     ),
//     pipe(tax, B.bimap(fai, fbx), B.bimap(fij, fxy)),
//   );
// };
//
// /*******************************************************************************
...
//   assertEquals(
//     pipe(tc, C.contramap((a: A) => fij(fai(a)))),
//     pipe(tc, C.contramap(fij), C.contramap(fai)),
//   );
// };
//
// /*******************************************************************************
...
//       ),
//     ),
//     pipe(tcx, P.promap(fij, fbx), P.promap(fai, fxy)),
//   );
// };
//
// /*******************************************************************************
